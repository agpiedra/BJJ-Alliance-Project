...
sending domain, and (found by driving the product as a registered owner instead of a seeded
user) **no way to create a second location** (B3, revision 33) and **a student account cannot
also be staff** (B4, found in revision 35 and reclassified from "will be hit" to a blocker in
revision 36). A fourth, **no staff management**, was closed by revision 35. The version of this paragraph before revision 33
