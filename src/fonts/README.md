...
The three font families the app uses are served from this repository with `next/font/local`
...
|---|---|---|---|---|
| Archivo (`--font-heading`) | 600, 700 | `archivo/Archivo-SemiBold.woff2`, `Archivo-Bold.woff2` | 2.001 | https://github.com/Omnibus-Type/Archivo `fonts/webfonts/` @ `211127690e8ff106c36c935f7e5e697114cff103` |
| IBM Plex Sans (`--font-sans`) | 400, 500, 600 | `ibm-plex-sans/IBMPlexSans-Regular.woff2`, `-Medium.woff2`, `-SemiBold.woff2` | 3.005 | https://github.com/IBM/plex `packages/plex-sans/fonts/complete/woff2/` @ `763c36ef9117782905ae010056dfbe8fd2653a25` |
...
```
5eb4dd14550d2c8771c20a8907fb17f0e9bcf57aa017fbc2cf571897b23a4135  archivo/Archivo-SemiBold.woff2
e289950dd907735e2d22f91b3af387fb5bf235f26dc45fb1b9133875d4b4b23d  archivo/Archivo-Bold.woff2
...
All three families are licensed under the **SIL Open Font License 1.1**, which allows use, embedding and redistribution with
the software. The licence text and copyright notice travel with the files:

- `archivo/OFL.txt` - Copyright 2020 The Archivo Project Authors (https://github.com/Omnibus-Type/Archivo)
